...
import IdentifyWarningLightsInDashboardScreen
    from '../IdentifyWarningLightsInDashboardScreen/IdentifyWarningLightsInDashboardScreen';
import IdentificationResultsScreen from "../IdentificationResultsScreen/IdentificationResultsScreen";
            ...
            <AppBar className="aboveDrawer">
                <Toolbar>
                    ...
                    <Button title="Home Screen"
                            ...
                            className="logoBtn"
                    >
                        <img className="logo" alt={''} src={'images/AutoLight_Logo.png'}/>
                    </Button>
...
const MyDrawer = withStyles(styles)(({
        ...
        <Router history={history}>
            ...
            <main>
                ...
                <Route exact path="/favorites" render={(props) => <Favorites {...props} user={user}/>}/>
