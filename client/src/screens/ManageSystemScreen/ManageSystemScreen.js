...
import {deleteWarningLight, handleEditWarningLights, listLights} from "../../actions/lightActions";
...
export default function SystemTable() {
    ...
    const warningLights = useSelector((state) => state.lightList);
            ...
            <TableContainer component={Paper} className="table-container">
                <Table className="table" aria-label="simple table">
                    ...
                    <TableBody id="TableBody">
                        {warningLights.lights && warningLights.lights.filter((light) => light.Name.toLowerCase().includes(searchParam.toLowerCase())).sort((a, b) => a.Id > b.Id ? 1 : -1).map((light, i) =>
                            (
